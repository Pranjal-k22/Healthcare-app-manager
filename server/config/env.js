...
const config = {
  ...
  // Email Notification Settings (Nodemailer + Resend relay / Gmail SMTP fallback)
  ...
  EMAIL_FROM:
    ...
    `"${process.env.EMAIL_FROM_NAME || 'HealthPulse Hospital'}" <${process.env.GMAIL_USER || process.env.SMTP_USER || 'onboarding@resend.dev'}>`,
