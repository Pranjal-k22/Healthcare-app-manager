...
/**
 * Doctor 6-Digit OTP Email Template sent upon Admin Approval
 */
const doctorOtpDelivery = (data) => {
  const { doctorName, otp, verifyUrl, expiresMinutes = 10 } = data;
  const subject = 'Your HealthPulse Doctor Verification Code';
  ...
  const contentHtml = `
    ...
    <p style="margin: 0 0 20px 0;">
      Your password reset request has been <strong>APPROVED</strong> by Hospital Administration. Use the 6-digit verification code below to set your new clinical account password:
    </p>
    ...
    <p style="margin: 0 0 16px 0; font-size: 13.5px; color: #64748B;">
      <strong>Security Warning:</strong> Do not share this verification code with anyone. HealthPulse staff will never ask for your verification code.
    </p>
  `;
...
module.exports = doctorOtpDelivery;
